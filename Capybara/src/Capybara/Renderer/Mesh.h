...
namespace Capybara {
	...
	struct AnimatedVertex
	{
		...
		void AddBoneData(uint32_t BoneID, float Weight)
		{
			...
			CPBR_CORE_WARN("Vertex has more than four bones/weights affecting it, extra data will be discarded (BoneID={0}, Weight={1})", BoneID, Weight);
		}
	};
	...
	struct VertexBoneData
	{
		...
		void AddBoneData(uint32_t BoneID, float Weight)
		{
			...
			CPBR_CORE_ASSERT(false, "Too many bones!");
		}
	};
